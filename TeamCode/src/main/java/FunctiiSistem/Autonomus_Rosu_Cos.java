...
@Autonomous(name = "Autonomus_Rosu_Cos", group = "Competition")
public class Autonomus_Rosu_Cos extends OpMode {
    ...
    public void buildPaths() {
        firstPath = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                ...
                                new Point(128.606, 14.186, Point.CARTESIAN)
                        )
                )
        ...
        secondPath = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Point(128.606, 14.186, Point.CARTESIAN),
                                new Point(126.406, 12.686, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(150), Math.toRadians(160.5))
        ...
        PusPrimul = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(160.5), Math.toRadians(150))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        ...
        thirdPath = follower.pathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(128.606, 9.243, Point.CARTESIAN),
                                new Point(125.005, 10.109, Point.CARTESIAN)
                        )
                )
                .setZeroPowerAccelerationMultiplier(3)
                .setLinearHeadingInterpolation(Math.toRadians(150), Math.toRadians(181))
        ...
        forthPath = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(125.105, 10.109, Point.CARTESIAN),
                                new Point(128.606, 9.243, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(181), Math.toRadians(140))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        ...
        LuatUltim = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(140), Math.toRadians(204))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        ...
        remainingPath = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(202), Math.toRadians(145))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        Parcare = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Point(126.606, 9.243, Point.CARTESIAN),
                                new Point(92.748, 40.757, Point.CARTESIAN)
                        )
                )
...
//                    follower.followPath(PusPrimul, 1.0, true);
    ...
    public synchronized void mid(){
        ...
        s.ext1.setPosition(0.475);
        s.ext2.setPosition(0.475);
    ...
    public synchronized void mid3(){
        s.rotire.setPosition(p.poz_rotire_ciung);
        s.ext1.setPosition(0.363);
        s.ext2.setPosition(0.363);
        s.brat_dr.setPosition(p.brat_dr_extindere);
        s.brat_st.setPosition(p.brat_st_extindere);
        s.incheietura.setPosition(p.incheiatura_luare);
    }
