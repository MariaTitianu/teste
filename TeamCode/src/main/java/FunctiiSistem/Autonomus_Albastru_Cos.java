...
@Autonomous(name = "Autosugus_Albastru_Cos", group = "Competition")
public class Autonomus_Albastru_Cos extends OpMode {
    ...
    public final Pose startPose = new Pose(8.500, 89.000, Math.toRadians(0));
    ...
    public void buildPaths() {
        firstPath = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(8.550, 89.000, Point.CARTESIAN),
                                new Point(15.794, 129.814, Point.CARTESIAN)
                        )
                )
        ...
        secondPath = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Point(15.794, 129.814, Point.CARTESIAN),
                                new Point(17.594, 129.814, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(-30), Math.toRadians(-20))
        ...
        PusPrimul = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(17.594, 128.814, Point.CARTESIAN),
                                new Point(15.394, 134.757, Point.CARTESIAN)
                        )
                )
        ...
        thirdPath = follower.pathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(15.394, 134.757, Point.CARTESIAN),
                                new Point(18.995, 133.051, Point.CARTESIAN)
                        )
                )
                .setZeroPowerAccelerationMultiplier(3)
                .setLinearHeadingInterpolation(Math.toRadians(-30), Math.toRadians(3.15))
        ...
        forthPath = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(18.895, 133.051, Point.CARTESIAN),
                                new Point(15.394, 134.757, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(4), Math.toRadians(-40))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        ...
        LuatUltim = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(15.394, 131.757, Point.CARTESIAN),
                                new Point(22.046, 132.258, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(-40), Math.toRadians(22))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        ...
        remainingPath = follower.pathBuilder()
                ...
                .addPath(
                        new BezierLine(
                                new Point(22.046, 132.258, Point.CARTESIAN),
                                new Point(17.394, 134.757, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(22), Math.toRadians(-42))
                .setZeroPowerAccelerationMultiplier(4)
                .build();
        Parcare = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Point(16.394, 134.757, Point.CARTESIAN),
                                new Point(55.252, 105.243, Point.CARTESIAN)
                        )
                )
...
//                    follower.followPath(PusPrimul, 1.0, true);
    ...
    public synchronized void luat(){
        ...
        new Thread(()->{
            ...
            while (s.brat_dr.getPosition() > 0.214 && !stop) {
                poz_dr = poz_dr - 0.012;
                poz_st = poz_st + 0.012;
